...
public class TextureListener implements TextureView.SurfaceTextureListener {
    ...
    public TextureListener(Activity context, int camNo, TextureView textureView) {
    ...
    public void openCamera() {
        ...
        try {
            cameraId = manager.getCameraIdList()[camNo];
    ...
    protected void TakePicture(TakePictureCallBack tpcb) {
        ...
        try {
            ...
            Log.d(TAG, "before OnImageAvailableListener Set:");
            ...
            ImageReader.OnImageAvailableListener readerListener = new ImageReader.OnImageAvailableListener() {
                ...
                public void onImageAvailable(ImageReader reader) {
                    ...
                    try {
                        ...
                        buffer.get(bytes);
                        tpcb.Save(TextureListener.this, bytes);
                    }
                    catch (Exception ex)
                    {
